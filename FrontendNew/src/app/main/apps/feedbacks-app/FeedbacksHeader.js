...
import FeedbackSearch from './FeedbacksSearch';
import { toggleVariateDescSize } from './store/feedbackSlice';

function FeedbacksHeader(props) {
	const dispatch = useDispatch();
	const variateDescSize = useSelector(({ feedbackApp }) => feedbackApp.feedbacks.variateDescSize);
